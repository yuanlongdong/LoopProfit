...
public:
    ...
    Q_INVOKABLE void exportRoundReportCsv(int userId, const QString &outputPath, const QString &fromIso = QString(), const QString &toIso = QString());
    Q_INVOKABLE QVariantList profitSeries(int userId) const;
